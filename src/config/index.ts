...
export {
  default as TDialogConfig, TDialogClassesKeys, TDialogClassesValidKeys, DialogBeforeShowParams, DialogBeforeHideParams, DialogHideFn, DialogShowFn, DialogResponse, DialogHideReason, DialogType, DialogIcon, DialogPreconfirmFn, DialogInputValidatorFn,
} from './TDialogConfig';
