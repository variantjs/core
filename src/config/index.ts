...
export {
  default as TDialogConfig, TDialogClassesKeys, TDialogClassesValidKeys, DialogBeforeCloseParams, DialogHideFn, DialogShowFn, DialogResponse, DialogHideReason, DialogInput, DialogType, DialogIcon, DialogPreconfirmFn, DialogInputValidatorFn,
} from './TDialogConfig';
